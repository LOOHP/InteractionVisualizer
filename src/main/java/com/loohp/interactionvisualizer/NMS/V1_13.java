...
public class V1_13 extends NMS {
	...
	public void createLight(World world, int x, int y, int z, LightType lightType, int light) {
		...
		worldServer.a(lightType == LightType.SKY ? EnumSkyBlock.SKY : EnumSkyBlock.BLOCK, new net.minecraft.server.v1_13_R1.BlockPosition(x, y, z), light);
	}
	...
	protected void recalculateLighting(World world, int x, int y, int z, LightType lightType) {
		WorldServer worldServer = ((CraftWorld) world).getHandle();
		net.minecraft.server.v1_13_R1.BlockPosition position = new net.minecraft.server.v1_13_R1.BlockPosition(x, y, z);
